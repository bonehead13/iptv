...
Based on [#6791](https://github.com/bonehead13/iptv/discussions/6791).

### I have a cable service and I want those channels to be on this IPTV. Is that possible?
No. This playlist does not replace traditional cable, a pay service, because this playlist can't include exclusive channels that may not be available on free-to-air. In other words, you will not have all the channels in the world. We recommend contacting your cable provider to offer legal alternatives to this service or visit the [iptv-org/awesome-iptv](https://github.com/bonehead13/awesome-iptv) repository for find other providers.

Based on [#859](https://github.com/bonehead13/iptv/issues/859) (about difference between this repository and providers), [#7205](https://github.com/bonehead13/iptv/issues/7205), [#7914](https://github.com/bonehead13/iptv/discussions/7914) and [#8102](https://github.com/bonehead13/iptv/discussions/8102).

### Does the playlist have a channel guide?
Yes, because an id of each channel is used to link to program guide because they are obtained from third party websites. However, not all channels have their EPG available. See [EPG](https://github.com/bonehead13/epg) for more info. Please note that the guide is not perfect and some channels (like international feeds) may interrupt programming without you knowing.

Note: For storage space reasons, the programming guide is only available in gz compressed format. See [discussion](https://github.com/bonehead13/iptv/discussions/8255).

Based on [#1797](https://github.com/bonehead13/iptv/issues/1797), [#2438](https://github.com/bonehead13/iptv/issues/2438), [#4537](https://github.com/bonehead13/iptv/discussions/4537) and [#7043](https://github.com/bonehead13/iptv/discussions/7043).

### Is it possible to view channels directly from the main website?
No. In our website, you will see an extensive list of channels and their respective information, like a global database. In this case, you will only be able to search and review the channels you want. If your favorite channel is legally available as an indexed stream in the IPTV playlist, there's a "Streams" option that will be available on the right side of the channel, so that you can have the link to watch it. Else, you can make an issue to ask for it. Please respect the [contribution guide](https://github.com/bonehead13/iptv/blob/master/CONTRIBUTING.md) before doing so.

Note: You can consult the information of the channels by country, write in the search box as `country:UK` (for UK, per example).

Based on [#1002](https://github.com/bonehead13/iptv/issues/1002), [#7415](https://github.com/bonehead13/iptv/issues/7415), [#7509](https://github.com/bonehead13/iptv/discussions/7509) and [#10242](https://github.com/bonehead13/iptv/discussions/10242).
...
If in the general playlist, you see NSFW channels displayed by mistake, we suggest that you report via an issue or edit their entries from the [Database](https://github.com/bonehead13/database) repository.

Based on [#1416](https://github.com/bonehead13/iptv/pull/1416), [#2126](https://github.com/bonehead13/iptv/issues/2126), [#9104](https://github.com/bonehead13/iptv/issues/9104), [#2234](https://github.com/bonehead13/iptv/issues/2234) and [#7245](https://github.com/bonehead13/iptv/pull/7245) (requests of hide NSFW channels in general playlist).
...
Based on [#81](https://github.com/bonehead13/iptv/issues/81) and [#3865](https://github.com/bonehead13/iptv/discussions/3865).

### Are you planning to include a VOD of TV shows broadcasted on this playlist?
No. This is not our purpose.

Based on [#175](https://github.com/bonehead13/iptv/issues/175), [#3290](https://github.com/bonehead13/iptv/discussions/3290), [#5466](https://github.com/bonehead13/iptv/issues/5466) and [#7852](https://github.com/bonehead13/iptv/discussions/7852).
...
Based on [#1432](https://github.com/bonehead13/iptv/issues/1432) (about over-the-air channels) and [#2732](https://github.com/bonehead13/iptv/issues/2732).
...
Based on [#1843](https://github.com/bonehead13/iptv/issues/1843) (request of geo-blocked channels), [#2191](https://github.com/bonehead13/iptv/issues/2191) and [#6558](https://github.com/bonehead13/iptv/issues/6558) (example of geo-blocked channel).

### Can I set a FTA channel that is broadcasted in specific cities or countries?
Yes. If the channel broadcasted in other cities or countries, please edit its entry onto the [Database](https://github.com/bonehead13/database) repository. It will be updated to the corresponding playlists.

When setting the city where the channel is broadcasted, set its timezone is not necessary because it is not relevant.

Based on [#747](https://github.com/bonehead13/iptv/issues/747) (first request), [#5802](https://github.com/bonehead13/iptv/discussions/5802) and [#6415](https://github.com/bonehead13/iptv/issues/6415).

### Can I safely add an FTA channel that broadcasts PPV events or pay programming?
Maybe, this may change in future answers. Consider if the country where it is broadcasted allows fair use. Owners can ban the broadcast of PPV events, and even issue a DMCA takedown. Check the [blocklist](https://github.com/bonehead13/database/blob/master/data/blocklist.csv) for more info about specific events, and this [counternotice](https://github.com/github/dmca/blob/3ce1c9402c6b7e46dcbbea6ff866d6a44e75c72a/2020/10/2020-10-08-dfl-counternotice.md) indicating that a DMCA takedown is invalid if only one FTA channel infringes copyright.
...
Some [valid takedowns](https://github.com/bonehead13/iptv/issues/6486) do occur when a Pull Request is made to notify us that we should not index their channels.

Based on [#440](https://github.com/bonehead13/iptv/issues/440) and [#7212](https://github.com/bonehead13/iptv/issues/7212).
...
After you have your m3u8 link, add your channel information by creating or editing the id (identifier) onto the [Database](https://github.com/bonehead13/database) repository. Then, submit an [issue](https://github.com/bonehead13/iptv/issues/new/choose) to propose it to us.

Notes:
* Because this is an community repository, we need the approval from two maintainers to accept your new additions. See [discussion](https://github.com/bonehead13/iptv/discussions/8412) for further explanations.
...
* The same id can only be used if a mirror stream is also proposed. Please do not set the same id for two different channels. See [PR](https://github.com/bonehead13/iptv/pull/9572).
* If for some reason you need to edit the name of your channel, the id from the Database will be changed. We suggest that you update the new id from the playlist as soon as possible because the streams of your channel with modified name will not be automatically linked. See [PR](https://github.com/bonehead13/iptv/pull/9632).

Based on [#650](https://github.com/bonehead13/iptv/issues/650) and [#6654](https://github.com/bonehead13/iptv/discussions/6654) (basic information).

### Is there any way to add my channel other than via this git repository?
No, there is no such option.

Based on [#2392](https://github.com/bonehead13/iptv/issues/2392).
...
Note: We do not accept the use of tokens, because they only work for a short time, which will end up in permanent offline (see [discussion](https://github.com/bonehead13/iptv/discussions/8838)). We also do not recommend using "chunks.m3u8", a other file type, for consistency reasons.

Based on [#1916](https://github.com/bonehead13/iptv/issues/1916) and [#5952](https://github.com/bonehead13/iptv/discussions/5952).
...
Based on [#5236](https://github.com/bonehead13/iptv/pull/5236), [#5401](https://github.com/bonehead13/iptv/pull/5401) and [#7576](https://github.com/bonehead13/iptv/discussions/7576) (about username and password of Xtream-Codes server).
...
Based on [#3017](https://github.com/bonehead13/iptv/discussions/3017) (about geo-blocked channel), [#4112](https://github.com/bonehead13/iptv/discussions/4412), [#4456](https://github.com/bonehead13/iptv/discussions/4456) and [#10246](https://github.com/bonehead13/iptv/discussions/10246).
...
Based on [#1196](https://github.com/bonehead13/iptv/pull/1196) (first pull request about this) [#2758](https://github.com/bonehead13/iptv/pull/2758) (visual radio example), [#5794](https://github.com/bonehead13/iptv/discussions/5794), [#6044](https://github.com/bonehead13/iptv/discussions/6044) and [#8788](https://github.com/bonehead13/iptv/discussions/8788).
...
Based on [#5818](https://github.com/bonehead13/iptv/discussions/5818).
...
Based on [#9312](https://github.com/bonehead13/iptv/discussions/9312).

### Why attributes of channels of this playlist like "tvg-country", "tvg-language", "tvg-logo" are missing?
The reason is to reduce the workload when adding streams in the list. Since "tvg-id" links to the [Database](https://github.com/bonehead13/database) repository, each channel has unique attributes like image, name (in English and local speak), country (or countries) broadcasted, category and language.
...
```
Based on [#2086](https://github.com/bonehead13/iptv/issues/2086) (countries), [#3490](https://github.com/bonehead13/iptv/discussions/3490) (duplicated tvg-id) and [#6516](https://github.com/bonehead13/iptv/issues/6516) (use of Database).
...
Based on [#2440](https://github.com/bonehead13/iptv/issues/2440).
...
Based on [#645](https://github.com/bonehead13/iptv/issues/645) (about package relases), [#6524](https://github.com/bonehead13/iptv/discussions/6524) and [#6855](https://github.com/bonehead13/iptv/issues/6855).
